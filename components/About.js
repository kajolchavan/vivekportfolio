            ...
            <div className="col-lg-7">
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <h2>
                  Crafting <span>Intuitive</span> Digital Experiences
                  </h2>
                  <p>
                  I
      have a total of 2 years of experience, ranging from UX writing, wireframing,
      front-end development and most importantly, UI/Visual designing.
                  </p>
                </div>
