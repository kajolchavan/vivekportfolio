              ...
              <div className="col-xl-12 col-md-12">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    ...
                    <div className="content">
                      <span className="years">1 March 2024 -  1 May 2024</span>
                      <h4>UI/UX Designer Intern</h4>
                      <h6>Dataastraa LLP</h6>
                      <span className="company">Mumbai, Maharashtra, India</span>
                      <p>Led the design and implementation of website
improvements, resulting in a 30% increase in
user engagement and a 20% increase in
conversion rates</p>
                    </div>
                  </div>
                </div>
                <div className="col-xl-12 col-md-12">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    ...
                    <div className="content">
                      <span className="years">January 2023</span>
                      <h4> Design Lead</h4>
                      <h6>Atharva College of Engineering.</h6>
                      <span className="company">Mumbai, Maharashtra, India</span>
                      <p>Led the design of AGI app. worked on UX flows,
Motion design, Prototyping, and Visual design.</p>
                    </div>
                  </div>
                </div>
                <div className="col-xl-12 col-md-12">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    ...
                    <div className="content">
                      <span className="years">15 August-2023</span>
                      <h4>Web Development and Designing</h4>
                      <h6>Oasis Infobyte</h6>
                      <span className="company">Mumbai, Maharashtra, India</span>
                      <p>Created a simple website using Html, Css,
Javascript.</p>
                    </div>
                  </div>
                </div>
