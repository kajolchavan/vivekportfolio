        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 text-lg-end">
              ...
              <li>
                  <a href="https://www.behance.net/vivekjha131">Behance</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/cre8ive_ui_ux/">Instagram</a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/vivek-jha-98b96221b/">LinkedIn</a>
                </li>
              </ul>
            </div>
          </div>
